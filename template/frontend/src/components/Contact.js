    ...
    <section className='my-28' id='contact'>
      ...
      <div className='md:mx-6 flex flex-col flex-wrap md:flex-row justify-between'>
        <div className='md:w-6/12 md:px-0 p-5 my-5'>
          <div>
            <p className='font-bold'>Sejoon Kim</p>
            <p className='font-thin'>Wolfsburg, Germany</p>
            <a href='mailto: bod092512@gmail.com' className='border-b-2 mt-3 inline-block border-gray-500'>
              bod092512@gmail.com
            </a>
          </div>
          <a className='border-b-2 mt-3 inline-block border-gray-500' href='./KimsejoonCV2.pdf' target='_blank' rel='noreferrer'>
            Resume
          </a>
          <div className='flex flex-row flex-wrap mt-7'>
            <div className='mr-4'>
              <a href='https://www.linkedin.com/in/sejokimde/' target='_blank' rel='noreferrer'>
            ...
            <div className='mr-4'>
              <a href='https://github.com/sejoonkimmm' target='_blank' rel='noreferrer'>
                <span className='mb-2 flex flex-row items-end border border-gray-500 p-2 rounded-lg text-sm'>
